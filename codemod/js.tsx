...
export type TooltipClassKey = 'popper' | 'tooltip' | 'touch' | 'tooltipPlacementLeft' | 'tooltipPlacementRight' | 'tooltipPlacementTop' | 'tooltipPlacementBottom';
...
class Tooltip extends React.Component<CodeProps,any> {
  ...
  componentDidMount() {
    warning(
      !this.childrenRef.disabled || !this.childrenRef.tagName.toLowerCase() ====== 'button' as any,
      [
