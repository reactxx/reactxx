...
export const getIconMap = () => {
    ...
    FSExtra.outputFileSync(Config.iconDesignRoot + 'map.json', JSON.stringify(map, null, 2), { encoding: 'utf8' })
    FSExtra.outputFileSync(Config.iconDesignRoot + 'errors.json', JSON.stringify(errorMap, null, 2), { encoding: 'utf8' })
}
