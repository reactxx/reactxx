...
rem forfiles /P %npm% /M reactxx-stateman* /C "cmd /c if @isdir==TRUE rmdir /s /q @file"
forfiles /P %npm% /M reactxx-activable* /C "cmd /c if @isdir==TRUE rmdir /s /q @file"
...
rem rmdir %npm%reactxx-stateman /s /q
rmdir %npm%reactxx-activable /s /q
...
call npm install --save-dev reactxx-basic reactxx-mdi reactxx-animation reactxx-mediaq reactxx-activable reactxx reactxx-mui %url%expo/types-expo-0.1.1.tgz
call jspm install npm:reactxx-mdi npm:reactxx-activable npm:reactxx-basic npm:reactxx-fela npm:reactxx-animation npm:reactxx-mediaq npm:reactxx npm:reactxx-mui
