...
import amber from 'reactxx-muix/current/colors/amber';
...
const MySnackbarContentWrapper = withStylesCreator(styles, {}1)(MySnackbarContent);
...
export default withStylesCreator(styles, {}2)(CustomizedSnackbars);
