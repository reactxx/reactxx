...
`;
    return <Grid container className={classes.root}>
        <Grid item xs={12}>
          <Grid container spacing={16} className={classes.demo} alignItems={alignItems} direction={direction} justify={justify}>
            ...
            <Grid container spacing={24}>
              <Grid item xs={12}>
                <FormControl component="fieldset">
                  ...
                  <RadioGroup row name="direction" aria-label="Direction" value={direction} onChange={this.handleChange('direction')}>
              ...
              <Grid item xs={12}>
                <FormControl component="fieldset">
                  ...
                  <RadioGroup row name="justify" aria-label="Justify" value={justify} onChange={this.handleChange('justify')}>
              ...
              <Grid item xs={12}>
                <FormControl component="fieldset">
                  ...
                  <RadioGroup row name="alignItems" aria-label="Align items" value={alignItems} onChange={this.handleChange('alignItems')}>
                    <FormControlLabel value="flex-start" control={<Radio />} label="flex-start" />
                    <FormControlLabel value="center" control={<Radio />} label="center" />
                    <FormControlLabel value="flex-end" control={<Radio />} label="flex-end" />
...
export default withStylesCreator((styles as any), InteractiveGrid)();