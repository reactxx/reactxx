...
!ReactxxDocExample[buttons/TextButtons]
...
!ReactxxDocExample[buttons/OutlinedButtons]
...
!ReactxxDocExample[buttons/ContainedButtons]
...
!ReactxxDocExample[buttons/FloatingActionButtons]
...
!ReactxxDocExample[buttons/FloatingActionButtonZoom]

## Sizes

Fancy larger or smaller buttons? Use the \`size\` or the \`mini\` property.

!ReactxxDocExample[buttons/ButtonSizes]
...
!ReactxxDocExample[buttons/IconButtons]

### Buttons with icons and label

Sometimes you might want to have icons for certain button to enhance the UX of the application as we recognize logos more easily than plain text. For example, if you have a delete button you can label it with a dustbin icon.

!ReactxxDocExample[buttons/IconLabelButtons]
...
!ReactxxDocExample[buttons/CustomizedButtons]
...
!ReactxxDocExample[buttons/ButtonBases]
