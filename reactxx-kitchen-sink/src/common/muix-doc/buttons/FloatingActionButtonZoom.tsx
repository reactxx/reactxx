...
class FloatingActionButtonZoom extends React.Component<any,any> {
  ...
  render() {
    const { classes, $system: {theme} } = this.props;
      ...
      <div className={classes.root}>
        ...
        {fabs.map((fab, index) => (
          <Zoom
            ...
            style={{
              $web: {transitionDelay: `${this.state.value === index ? transitionDuration.exit : 0}ms`,
            }}}
            unmountOnExit
          >
...
export default withStylesCreator(styles as any, FloatingActionButtonZoom, { withTheme: true })();
