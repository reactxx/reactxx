...
import Select from 'reactxx-muix/current/Select';
import NativeSelect from 'reactxx-muix/current/NativeSelect';
...
export default withStylesCreator(styles, {})(NativeSelects);
