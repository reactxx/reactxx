...
class ProgressMobileStepper extends React.Component<any, any> {
  ...
  render() {
    ...
    return <MobileStepper variant="progress" steps={6} position="static" activeStep={this.state.activeStep} className={classNames(classes.root)} nextButton={<Button size="small" onClick={this.handleNext} disabled={this.state.activeStep === 5}>
            Next
