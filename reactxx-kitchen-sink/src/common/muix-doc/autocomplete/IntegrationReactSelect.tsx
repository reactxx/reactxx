...
import NoSsr from 'reactxx-muix/current/NoSsr';
...
import { emphasize } from 'reactxx-muix/current/styles/colorManipulator';
...
export default withStylesCreator(styles, {})(IntegrationReactSelect);
