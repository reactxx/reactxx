...
import MarkdownElement from '../../mui-doc-app/MarkdownElement';
...
class AnchorPlayground extends React.Component<any, any> {
  anchorEl = null;
  state: any = {
    open: false,
    ...
    return <div>
        <Grid container justify="center" spacing={0}>
          <Grid item className={classes.buttonWrapper}>
            ...
            this.anchorEl = node;
          }} variant="contained" onClick={this.handleClickButton}>
              Open Popover
            </Button>
            {anchorReference === 'anchorEl' && <div className={classes.anchor} style={{ ...inlineStyles.anchorVertical[anchorOriginVertical],
            ...inlineStyles.anchorHorizontal[anchorOriginHorizontal]
          }} />}
          </Grid>
        </Grid>
        <Popover open={open} anchorEl={this.anchorEl} anchorReference={anchorReference} anchorPosition={{
        top: positionTop,
        left: positionLeft
        ...
        <Grid container spacing={16}>
          <Grid item xs={12} sm={6}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row aria-label="anchorReference" name="anchorReference" value={anchorReference} onChange={this.handleChange('anchorReference')}>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl className={classes.formControl}>
              ...
              <Input id="position-top" type="number" value={positionTop} onChange={this.handleNumberInputChange('positionTop')} />
            </FormControl>
            &nbsp;
            <FormControl className={classes.formControl}>
              <InputLabel htmlFor="position-left">anchorPosition.left</InputLabel>
              <Input id="position-left" type="number" value={positionLeft} onChange={this.handleNumberInputChange('positionLeft')} />
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6}>
            <FormControl component="fieldset">
              <FormLabel component="legend">anchorOrigin.vertical</FormLabel>
              <RadioGroup aria-label="anchorOriginVertical" name="anchorOriginVertical" value={anchorOriginVertical} onChange={this.handleChange('anchorOriginVertical')}>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl component="fieldset">
              ...
              <RadioGroup aria-label="transformOriginVertical" name="transformOriginVertical" value={transformOriginVertical} onChange={this.handleChange('transformOriginVertical')}>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row aria-label="anchorOriginHorizontal" name="anchorOriginHorizontal" value={anchorOriginHorizontal} onChange={this.handleChange('anchorOriginHorizontal')}>
          ...
          <Grid item xs={12} sm={6}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row aria-label="transformOriginHorizontal" name="transformOriginHorizontal" value={transformOriginHorizontal} onChange={this.handleChange('transformOriginHorizontal')}>
...
export default withStylesCreator((styles as any), AnchorPlayground)();