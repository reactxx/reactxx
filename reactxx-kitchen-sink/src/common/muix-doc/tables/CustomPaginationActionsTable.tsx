...
import TableFooter from 'reactxx-muix/current/TableFooter/TableFooter';
...
import FirstPageIcon from 'reactxx-icons/FirstPage';
...
import LastPageIcon from 'reactxx-icons/LastPage';
...
const TablePaginationActionsWrapped = withStylesCreator((actionsStyles as any), TablePaginationActions, {
  withTheme: true
})();
let counter = 0;
...
class CustomPaginationActionsTable extends React.Component<any, any> {
  constructor(props) {
    super(props);
    this.state = {
      data: [createData('Cupcake', 305, 3.7), createData('Donut', 452, 25.0), createData('Eclair', 262, 16.0), createData('Frozen yoghurt', 159, 6.0), createData('Gingerbread', 356, 16.0), createData('Honeycomb', 408, 3.2), createData('Ice cream sandwich', 237, 9.0), createData('Jelly Bean', 375, 0.0), createData('KitKat', 518, 26.0), createData('Lollipop', 392, 0.2), createData('Marshmallow', 318, 0), createData('Nougat', 360, 19.0), createData('Oreo', 437, 18.0)].sort((a, b) => a.calories < b.calories ? -1 : 1),
      page: 0,
      rowsPerPage: 5
    };
  }
    ...
    return <Paper className={classNames(classes.root)}>
        <div className={classNamesStr(classes.tableWrapper)}>
          <Table className={classNames(classes.table)}>
            ...
            <TableFooter>
              <TableRow>
                <TablePagination colSpan={3} count={data.length} rowsPerPage={rowsPerPage} page={page} onChangePage={this.handleChangePage} onChangeRowsPerPage={this.handleChangeRowsPerPage} ActionsComponent={TablePaginationActionsWrapped} />
              </TableRow>
            </TableFooter>
          </Table>
        </div>
...
export default withStylesCreator((styles as any), CustomPaginationActionsTable)();