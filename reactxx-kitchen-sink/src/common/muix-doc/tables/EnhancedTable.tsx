...
import TablePagination from 'reactxx-mui-web/TablePagination/TablePagination';
import TableRow from 'reactxx-mui-web/TableRow/TableRow';
import TableSortLabel from 'reactxx-mui-web/TableSortLabel/TableSortLabel';
  ...
  render() {
    ...
    return <TableHead>
        <TableRow>
          ...
          {rows.map(row => {
          return <TableCell key={row.id} numeric={row.numeric} padding={row.disablePadding ? 'none' : 'default'} sortDirection={orderBy === row.id ? order : false}>
