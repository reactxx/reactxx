...
import TablePagination from 'reactxx-muix/current/TablePagination';
import TableRow from 'reactxx-muix/current/TableRow';
import TableSortLabel from 'reactxx-muix/current/TableSortLabel';
...
import { lighten } from 'reactxx-muix/current/styles/colorManipulator';
...
export default withStylesCreator(styles, {})(EnhancedTable);
