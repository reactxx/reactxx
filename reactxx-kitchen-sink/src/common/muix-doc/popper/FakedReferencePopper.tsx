...
class FakedReferencePopper extends React.Component<any, any> {
  state: any = {
    anchorEl: null,
    open: false
  };
  handleMouseUp = () => {
    const selection = window.getSelection(); // Resets when the selection has a length of 0
  ...
  render() {
    ...
    return <div onMouseLeave={this.handleClose}>
...
export default withStylesCreator((styles as any), FakedReferencePopper)();