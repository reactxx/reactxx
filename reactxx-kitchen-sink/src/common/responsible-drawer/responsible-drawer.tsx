...
const App: React.SFC = () => <ResponsibleDrawer className={{ $native: { marginTop: 24 } }} drawer={ // drawer
  ...
  <ScrollView classes={{ container: { flex: 1 } }}> {/* content */}
    ...
    <Text className={{ fontSize: 32, margin: 40 }}>{window.isWeb ? 'Change browser window width' : 'Rotate your device'} to see different Drawer's behavior for MOBILE, TABLET and DESKTOP</Text>
