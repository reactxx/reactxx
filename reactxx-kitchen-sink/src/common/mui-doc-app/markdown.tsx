...
import markdownToReact from './markup'
...
const Markdown: Types.CodeSFCWeb<Shape> = props => {
    ...
    return <div className={classes.root}>
        {markdownToReact(text, ReactxxDocExample)}
    </div>
}

class ReactxxDocExample extends React.Component<{ path: string }> {
    render() {
        return <h3>{this.props.path}</h3>
    }
}
