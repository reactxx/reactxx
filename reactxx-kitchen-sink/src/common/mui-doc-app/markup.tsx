    ...
    return remark()
        ...
        .use(remarkReact, {
            createElement: (name, props, children) => {
                ...
                return React.createElement(name, { className: htmlTagClassName, ...(props || null) }, children)
            },
...
export const markdownToReact = (markdown: string, markdownDefineResult: MarkdownDefinition) => 
  markdownDefineResult.processSync(markdown, { commonmark: true }).contents
