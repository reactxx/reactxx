...
export const ResponsibleDrawerCreator = withStylesCreator<TResponsibleDrawer.Shape, { LayoutChanged: typeof Consumer }>(sheet, responsibleDrawer, {
  name:TResponsibleDrawer.Consts.Drawer,
