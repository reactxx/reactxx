declare namespace PrimComps {
  type PropsLow<T extends ReactXX.Ruleset, P extends {}, W extends {} = React.HTMLAttributes<HTMLDivElement>> = {
    className?: T
    style?: T
  ...
  type Icon = PropsLow<ReactN.TextStyle, { color?: string; size?: number }> & { data?: MuixIcons }
  type IconX = PropsLow<ReactN.TextStyle | React.CSSProperties, { color?: string; size?: number }> & { data?: MuixIcons }
