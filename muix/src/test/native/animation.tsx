...
class RNView extends React.PureComponent {
  ...
  render() {
    ...
    Animated.timing(rnValue, { ...rnConfig, toValue: this.renderState.open ? 1 : 0 }).start() 
    return <View>
...
type Animation<T extends TCommonStyles.RulesetNativeIds> = Types.RulesetX<T> & { $easing?: string, $duration?: number, $delay?: number }

const transitionCreate = (par: (theme: Muix.Theme) => Types.RulesetX<'View'> & { $easing?: string, $duration?: number, $delay?: number }) => null as ITransition
