...
const button: Muix.CodeSFCNative<MuixButton.Shape> = (props, context) => {
  ...
  const { children, classes, color = 'default', dense, fab, raised, mini, getStyleWithSideEffect, className, ...rest } = props
  ...
  return <RippleEffect viewStyle={viewStyle} rippleStyle={rippleStyle} activeStyle={activeStyle} classes={null} className={null} getStyleWithSideEffect={null} {...rest}>
    {childs}
  </RippleEffect>
}
