...
export const defaultProps = (BottomNavigationAction.defaultProps = {});

export const BottomNavigationActionCode = BottomNavigationAction;
...
export const BottomNavigationActionComponent = BottomNavigationActionCreator();
