...
const styles = theme => ({
  ...
  display4: {
    $web: theme.typography.display4
  },

  /* Styles applied to the root element if `variant="display3"`. */
  display3: {
    $web: theme.typography.display3
  },

  /* Styles applied to the root element if `variant="display2"`. */
  display2: {
    $web: theme.typography.display2
  },

  /* Styles applied to the root element if `variant="display1"`. */
  display1: {
    $web: theme.typography.display1
  },

  /* Styles applied to the root element if `variant="headline"`. */
  headline: {
    $web: theme.typography.headline
  },

  /* Styles applied to the root element if `variant="title"`. */
  title: {
    $web: theme.typography.title
  },

  /* Styles applied to the root element if `variant="subheading"`. */
  subheading: {
    $web: theme.typography.subheading
  },

  /* Styles applied to the root element if `variant="body2"`. */
  body2: {
    $web: theme.typography.body2
  },

  /* Styles applied to the root element if `variant="body1"`. */
  body1: {
    $web: theme.typography.body1
  },

  /* Styles applied to the root element if `variant="caption"`. */
  caption: {
    $web: theme.typography.caption
  },

  /* Styles applied to the root element if `variant="button"`. */
  button: {
    $web: theme.typography.button
  },
