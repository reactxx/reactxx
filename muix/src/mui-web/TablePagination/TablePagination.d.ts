...
import { TablePaginationClassKey, TablePaginationProps } from './TablePagination_';

export * from './TablePagination_';
...
declare const TablePagination: React.ComponentClass<PropsX>
