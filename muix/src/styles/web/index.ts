...
export const shadows = shadowsStrings.map(s => ({ boxShadow: s } as Muix2.commonViewRuleset))

import { toPlatformSheetX, toPlatformRuleSetX } from '../common/index'

export const toPlatformRuleSet = (style: Muix2.TRulesetX) => toPlatformRuleSetX(style, false) as React.CSSProperties
export const toPlatformSheet = <R extends Muix.Shape>(rules: Muix2.PartialSheetX<R>) => toPlatformSheetX(rules, false) as Muix2.SheetWeb<R>
