...
const text: TBasic.CodeSFCWeb<TComps.TextShape> = props => {
  const { style, classes, numberOfLines, mergeRulesetWithOverrides, theme, animations, mediaqFlags, url, onClick, ...rest } = props
...
const scrollView: TBasic.CodeSFCWeb<TComps.ScrollViewShape> = props => {
  const { style, classes, horizontal, mergeRulesetWithOverrides, theme, animations, children, mediaqFlags, ...rest } = props
