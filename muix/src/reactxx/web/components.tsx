...
const icon: ReactXX.CodeSFCWeb<CompsT.IconShape> = props => {
...
const text: ReactXX.CodeSFCWeb<CompsT.TextShape> = props => {
...
const scrollView: ReactXX.CodeSFCWeb<CompsT.ScrollViewShape> = props => {
