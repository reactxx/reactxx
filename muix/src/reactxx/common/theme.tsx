...
export const compThemeModifier = <Shape1 extends ReactXX.Shape, Shape2 extends ReactXX.Shape = never, Shape3 extends ReactXX.Shape = never>(name1: ReactXX.getNameType<Shape1>, comp1: ThemeT.ThemeCompCreatorX<Shape1>, name2?: ReactXX.getNameType<Shape2>, comp2?: ThemeT.ThemeCompCreatorX<Shape2>, name3?: ReactXX.getNameType<Shape3>, comp3?: ThemeT.ThemeCompCreatorX<Shape3>) => (themeState: ThemeT.ThemeState) => {
...
export const compThemeParModifier = <Shape1 extends ReactXX.Shape, Shape2 extends ReactXX.Shape = never, Shape3 extends ReactXX.Shape = never>(name1: ReactXX.getNameType<Shape1>, comp1: ThemeT.ThemeParCreatorX<Shape1>, name2?: ReactXX.getNameType<Shape2>, comp2?: ThemeT.ThemeParCreatorX<Shape2>, name3?: ReactXX.getNameType<Shape3>, comp3?: ThemeT.ThemeParCreatorX<Shape3>) => (themeState: ThemeT.ThemeState) => {
  const theme = themeState.theme
...
export const compThemeSheetModifier = <Shape1 extends ReactXX.Shape, Shape2 extends ReactXX.Shape = never, Shape3 extends ReactXX.Shape = never>(name1: ReactXX.getNameType<Shape1>, comp1: ThemeT.PartialSheetCreatorX<Shape1>, name2?: ReactXX.getNameType<Shape2>, comp2?: ThemeT.PartialSheetCreatorX<Shape2>, name3?: ReactXX.getNameType<Shape3>, comp3?: ThemeT.PartialSheetCreatorX<Shape3>) => (themeState: ThemeT.ThemeState) => {
  const theme = themeState.theme
...
export const compThemeParCreate = <R extends ReactXX.Shape>(theme: ThemeT.ThemeX, par: ThemeT.ThemeParCreatorX<R>) => typeof par === 'function' ? par(theme) : par
export const compThemeSheetCreate = <R extends ReactXX.Shape>(theme: ThemeT.ThemeX, compThemePar: ReactXX.getCompTheme<R>, sheet: ThemeT.PartialSheetCreatorX<R>) => typeof sheet === 'function' ? sheet(theme, compThemePar) : sheet
export const compThemeCreate = <R extends ReactXX.Shape>(theme: ThemeT.ThemeX, comp: ThemeT.ThemeCompCreatorX<R>) => { const par = compThemeParCreate(theme, comp.par); return { par, sheet: compThemeSheetCreate(theme, par, comp.sheet) } as ThemeT.ThemeCompX<R> }
